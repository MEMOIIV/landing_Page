    ...
    return (
        ...
        <section className="p-12 my-12 w-[90%] mx-auto">
            ...
            <div className="shadow-md rounded-md">
                ...
                <img src="/images/image-currency.jpg" className="rounded-md  lg:h-[181.79px] lg:w-full" alt="money" />
            ...
            <div className="shadow-md rounded-md">
                ...
                <img src="/images/image-restaurant.jpg" className="rounded-md lg:h-[181.79px] md:h-[214.41px] w-full" alt="money" />
            ...
            <div className="shadow-md rounded-md">
                ...
                <img src="/images/image-plane.jpg" className="rounded-md lg:h-[181.79px] md:h-[214.41px] w-full" alt="money" />
            ...
            <div className="shadow-md rounded-md">
                ...
                <img src="/images/image-confetti.jpg" className="lg:h-[181.79px] md:h-[214.41px] w-full rounded-md" alt="money" />
            ...
            <div className="grid grid-cols-12 gap-4 w-[85%] mx-auto">
                ...
                <div className="lg:col-span-3 md:col-span-3
                    ...
                    <div className="flex justify-center">
                        <ReactSVG src="/images/logo.svg" className="lg:pb-10 md:pb-10 sm:pb-8 xs:pb-8  text-white " alt="logo" />  
                    </div>
                    <div className="flex lg:justify-around md:justify-center sm:justify-center xs:justify-center px-2 lg:pb-0 md:pb-0 sm:pb-3 xs:pb-3 ">
                        <ReactSVG src="/images/icon-facebook.svg"  className="cursor-pointer mx-0  md:mx-2 sm:mx-2 xs:mx-2 text-gray-100
                        hover:text-green-500  duration-300 transition-all  " alt="facebook"/>
                        <ReactSVG src="/images/icon-youtube.svg"   className="cursor-pointer mx-0  md:mx-2 sm:mx-2 xs:mx-2 text-gray-100
                        hover:text-green-500  duration-300 transition-all  " alt="youtube"/>
                        <ReactSVG src="/images/icon-twitter.svg"   className="cursor-pointer mx-0  md:mx-2 sm:mx-2 xs:mx-2 text-gray-100
                        hover:text-green-500  duration-300 transition-all  " alt="twitter"/>
                        <ReactSVG src="/images/icon-pinterest.svg" className="cursor-pointer mx-0  md:mx-2 sm:mx-2 xs:mx-2 text-gray-100
                        hover:text-green-500  duration-300 transition-all  " alt="pinterest"/>
                        <ReactSVG src="/images/icon-instagram.svg" className="cursor-pointer mx-0  md:mx-2 sm:mx-2 xs:mx-2 text-gray-100
